...
pre_processing = {
    ...
    'adhd_dia_file':'All_materials/20250905_Plot_data_for_the_OpenSAFELY_ADHD_Project/source_files/open_data/Table 1 - ADHD prevalence.csv',
    'rename_dict':{
        'Reporting_Period_Start_Date':'interval_start',
        'Reporting_Period_End_Date':'interval_end',
        'Age_Band':'age_band',
        'Sex':'sex',
        'Numerator':'numerator',
